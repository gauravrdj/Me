...
import { FaReact, FaCss3Alt, FaHtml5, FaJsSquare, FaCss3, FaNodeJs, FaCloudflare, FaDocker} from "react-icons/fa";
import { DiJsBadge,DiNodejs } from "react-icons/di";
import { SiNextdotjs , SiTypescript,SiExpress,SiFramer,SiPrisma, SiPostgresql,SiTurborepo,SiMongodb } from "react-icons/si";
import { RiTailwindCssFill } from "react-icons/ri";
import { BiLogoTypescript } from "react-icons/bi";
import { CpDemo } from "@/components/demos/cp";
...
const projects = [
  {
    ...
    link: "https://payments-app-new.onrender.com/",
    date: "2024",
    image: "/images/paytm.png",
    techStack: ["FaReact", "DiJsSquare", "SiNextdotjs", "RiTailwindCssFill","SiTypescript", "SiPrisma", "SiPostgresql", "FaNodeJs", "SiTurborepo", "FaDocker"], // Use tech names
  },
  {
    title: "Medium",
    description: "Publishing Plateform",
    link: "https://publishingmedium.netlify.app/",
    date: "2024",
    image: "/images/medium.png",
    techStack: ["RiTailwindCssFill","FaReact", "SiPostgresql","FaNodeJs", "SiTypescript", "FaCloudflare", "SiPrisma"],
  },
  {
    title: "DPMS",
    description: "Dynamic Profile Management System",
    link: "https://getmyprofile.netlify.app/",
    date: "2024",
    image: "/images/dpms.png",
    techStack: ["FaNodeJs","FaReact", "RiTailwindCssFill", "SiMongodb","DiJsSquare","SiExpress"],
  },
  // {
...
const experience = [
  ...
  description: "Appco Software",
  date: "May 2024 - July 2024",
  image: "/images/appco.png",
},
// {
...
const education = [
  {
    ...
    date: "2021-2025",
    image: "/images/nitrkl.png",
  },
  {
    title: "XIIth Board Exam",
    description: "93.80% Marks",
    date: "2020",
    image: "/images/jnv.jpeg",
  },
  {
    title: "Xth Board Exam",
    description: "91.40% Marks",
    date: "2018",
    image: "/images/jnv.jpeg",
  },
];
...
const skills =  [
  {
    ...
    description: "JavaScript, TypeScript, Python, Java, C++, C, SQL",
  },
  {
    title: 'Web Technologies',
    description: "React, Next.js, Node.js, Express, Recoil, Hono, Prisma, Websocket",
  },
  // {
  ...
  {
    title: 'Cloud & DevOps',
    description: "Docker, GitHub, Monorepo, CI/CD Pipeline, Cloudflare Workers",
  },
  {
    title: 'Databases',
  ...
  // },
  {
    ...
    description: "Git, npm, VSCode, Postman, Windows",
  },
  {
    title: 'Course Works',
    description: "Data Structures and Algorithms, Operating Systems, OOPs, Full-Stack Development",
  }
];
...
const icons = [
  ...
  'javascript', 'typescript', 'python', 'java', 'cpp', 'c', 'sql',
  
  // Web Technologies
  'react', 'nextdotjs', 'nodedotjs', 'express', 'socket', 'vite', 'leetcode', 'geeksforgeeks', 'codechef', 'codeforces', 
  // Mobile Development
  // 'kotlin', 'reactnative', 'flutter','expo', 
  
  // Cloud & DevOps
   'googlecloud', 'docker',  'github', "prisma" ,
  
  // Databases
  'mongodb', 'postgresql', 'mysql',  
  
  // Frontend Frameworks & Libraries
  'recoil', 'tailwindcss', 'bootstrap', 
  ...
  'git', 'npm', 'vscode', 'visualstudiocode', 'postman', 'windows'
]
...
export default function Home() {
  ...
  const phoneNumber=9799081362;
  const iconMapping: { [key in "FaReact" | "FaCss3Alt" | "FaHtml5" | "FaJsSquare"  | "DiJsSquare" | "SiNextdotjs" | "SiTypescript"|"SiExpress"| "SiFramer" | "RiTailwindCssFill" | "BiLogoTypescript" | "SiPrisma" | "SiPostgresql" | "FaNodeJs" | "SiTurborepo" | "FaCloudflare" | "SiMongodb" | "FaDocker" ]: JSX.Element } = {
    ...
    RiTailwindCssFill: <RiTailwindCssFill className = "text-blue-500 w-6 h-6"/>,
    BiLogoTypescript : <BiLogoTypescript className="text-blue-500 w-6 h-6"/>,
    SiPrisma : <SiPrisma className="w-6 h-6"/>,
    SiPostgresql: <SiPostgresql className="text-blue-800 w-6 h-6"/>,
    FaNodeJs : <FaNodeJs className="text-green-600 w-6 h-6"/>,
    SiTurborepo : <SiTurborepo className="text-pink-600 w-6 h-6"/>,
    FaCloudflare : <FaCloudflare className="text-orange-600 w-6 h-6"/>,
    SiMongodb : <SiMongodb className="text-green-600 w-6 h-6"/>,
    FaDocker : <FaDocker className="text-blue-600 w-6 h-6"/>
  };
  ...
  <DialogContent>
    <div className="hidden md:flex md:gap-x-10 items-center">
      ...
      <div className="space-y-2">
        ...
        <h1 className="text-xl lg:text-4xl font-semibold">
          <Typewriter words={["Hi, I am Gaurav Sharma !! I build things for the web."]} cursor />
        </h1>
        ...
        <p className="text-muted-foreground text-lg">
          Feel free to reach out to me on{" "}
          <LinkPreview url="https://www.linkedin.com/in/gaurav-sharma-9556b2196/" className="font-bold">
            {/* <PiDiscordLogoFill className="h-6 w-6 inline text-indigo-500" />{" "} */}
            <span className="text-indigo-500 underline">Linkedin</span>
          </LinkPreview>{" "}
          I am always happy to help.
        </p>
      </div>
          ...
          <div className="md:flex md:gap-x-10 items-center md:pt-28">
            ...
            >
              ...
              <h1 className="text-xl lg:text-4xl font-semibold">
                <Typewriter
                  words={["Hi, I am Gaurav Sharma !! I build things for the web."]}
                  cursor
                />
              </h1>
            ...
            A passionate innovator and problem-solver who thrives on turning ideas into impactful solutions. With creativity, determination, and a drive to excel, I aim to make a difference in every project I take on. Let&apos;s create something amazing together! 🌟</p>
              <p className="text-muted-foreground text-lg ">
                Feel free to reach out to me on{" "}
                <LinkPreview
                  url="https://www.linkedin.com/in/gaurav-sharma-9556b2196/"
                  className="font-bold"
                >
                  {/* <PiDiscordLogoFill className="h-6 w-6 inline text-indigo-500" />{" "} */}
